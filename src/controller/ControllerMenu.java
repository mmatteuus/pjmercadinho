...
public class ControllerMenu {
    ...
    @FXML private void onNavClientes(ActionEvent e) {
        navigateTo("/view/viewCadrastroCliente.fxml", "Mercadinho - Clientes");
    }

    @FXML private void onNavProdutos(ActionEvent e) {
        navigateTo("/view/viewCadastroProduto.fxml", "Mercadinho - Produtos");
    }
    ...
    @FXML private void onNavFuncionarios(ActionEvent e) {
        navigateTo("/view/viewCadastroFuncionario.fxml", "Mercadinho - Funcionários");
    }
